...
public interface KaxxItemProvider {
     ...
     */
    default void init(Player player, ItemStack baseItem){}
     ...
     */
    default void onDrop(Player player, PlayerDropItemEvent event){}
     ...
     */
    default void onPickup(Player player, PlayerPickupItemEvent event){}
     ...
     */
    default void onBreak(Player player, PlayerItemBreakEvent event){}
     ...
     */
    default void onDurabilityChange(Player player, PlayerItemDamageEvent event){}
